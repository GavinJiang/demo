...
var GAME_UN_STARTED = {val: 1, msg: '游戏未开始'};
var GAME_STARTED = {val: 2, msg: '游戏开始'};
var GAME_PAUSED = {val: 3, msg: '游戏暂停'};
var GAME_OVER = {val: 4, msg: 'GAME OVER，请重新开始'};
...
function refreshScoreHistory(){
	...
	if($.isArray(scores) && scores.length > 0){
		$scoreHistoryTable.append('<tr><th>序号</th><th>时间</th><th>得分</th></tr>');
